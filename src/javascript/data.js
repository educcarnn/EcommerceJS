const dataBase = [
    {
        img: './src/css with imgs/img/Men-Jacket-Front-Black__15466 1.svg',
    ...
    {
        img: './src/css with imgs/img/image 1.svg',
    ...
    {
        img: './src/css with imgs/img/Surgical-Mask-Black__89554 1.svg',
        categorias: ['Acessórios'],
        titulo: 'Mask',
    ...
    {
        img: './src/css with imgs/img/Men-TShirt-Black-Front__70046 1.svg',
        categorias: ['Camisetas'],
        titulo: 'T-Shirt',
    ...
    {
        img: './src/css with imgs/img/mockup-a0dc2330__62146 1.svg',
        categorias: ['Camisetas'],
